...
project = 'RSI-SelfSupervised'
copyright = '2022, EarthNets'
author = 'RSI-SelfSupervised Authors'
    ...
    'menu': [
        {
            'name': 'Tutorial',
            'url':
            'https://github.com/EarthNets/RSI-SelfSupervised/blob/main/'
            'demo/rsi_selfsupervised_tutorial.ipynb'
        },
        {
            'name': 'GitHub',
            'url': 'https://github.com/EarthNets/RSI-SelfSupervised'
        },
        {
            'name':
            'About',
